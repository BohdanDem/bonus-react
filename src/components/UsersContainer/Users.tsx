...
//         // dispatch(userActions.setCurrent(users.find(user => user.id === +selectRef.current.value)))    для одиничного вибору
//
...
//                 {/*/!*<option value="please select user"></option>*!/         для одиничного вибору*/}
